  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 max-w-2xl mx-auto pb-20">
      ...
      <div className="prose prose-sm text-gray-700 space-y-4">
        ...
        <p>VicinityShare ("we", "our", "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your personal information when you use our application.</p>
